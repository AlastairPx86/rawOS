...
; quotient dw 0h
; decimals dw 0h
; ros_math_divide_advanced:
;     ; Store all registers which we do not want to modify
;     push si
;     push di
;     mov cx, 0h
;     add si, 1h
; ros_math_divide_advanced_repeat:
;     div bx
;     cmp cx, 0h
;     je ros_math_divide_advanced_add_q
;     jne ros_math_divide_advanced_add_r
; ros_math_divide_advanced_add_q:
;     mov [quotient], ax
;     jmp ros_math_divide_advanced_check
; ros_math_divide_advanced_add_r:
...
;     jne ros_math_divide_advanced_decimal_overflow
...
;     jmp ros_math_divide_advanced_repeat

; ros_math_divide_advanced_done:
;     mov cx, dx
;     mov dx, decimals
;     mov ax, quotient
...
;     pop si
;     ret
; ros_math_divide_advanced_decimal_overflow:
;     pusha
